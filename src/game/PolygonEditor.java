 ...
 * in the game (the height that you specify in your call to the BodyImage constructor).
 * If you don't specify the height, it defaults to 4.
 *
 * Example 2:
 *
...
{   private static double WIDTH = 500;
     ...
     * of the form -height f, where f is a floating-point number (the default value is 4.0).
    ...
    public static void main(String[] args) {
        String fileName = "data/floor.png";
